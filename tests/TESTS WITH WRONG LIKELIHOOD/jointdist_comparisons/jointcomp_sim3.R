...
for(k in 1:samp_size){
    ...
    statuses[,k] <- c(ifelse(obstimes < path.cur[2], 1, 0), ifelse(obstimes < path.new[2], 1, 0))
}
...
png("infecprob_sim3.png", width = 750, height = 550)
...
png("infecprob_demeaned_sim3.png", width = 750, height = 550)
