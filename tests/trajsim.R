...
trajecs.gg <- ggplot(data = trajecs, aes(x = time, y = infected, group = simnum)) + geom_line(alpha = 0.3) + geom_line(data = truetrajec, aes(x = time, y = infected),colour="red", size = 1) + 
