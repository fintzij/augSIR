...
for(k in 2:niter){
    ...
    if(k %% 500 == 0){
        sink(paste(paste("log",popsize,samp_prob,R0,initialization_num,sep="_"),".txt", sep=""), append=TRUE)  
...
save(list = paste("augSIR_",popsize,samp_prob,R0,initialization_num,sep="_"), file = paste(paste("augSIR_",popsize,samp_prob,R0,initialization_num,sep="_"),".Rdata", sep=""))
