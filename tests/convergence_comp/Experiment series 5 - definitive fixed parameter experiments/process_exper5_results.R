...
setwd("C:/Users/Jonathan/Google Drive/UW/Year 3 +/Dissertation/Code/augSIR/tests/convergence_comp/Experiment series 5 - definitive fixed parameter experiments/Results data files")

# Collect data for each R0 ------------------------------------------------

files <- list.files()

simsettings <- expand.grid(simnum = 1:10, popsize = c(50, 150, 300), censusInterval = c(0.05, 0.2), samp_prob = c(0.1, 0.4), R0 = c(4, 8))
